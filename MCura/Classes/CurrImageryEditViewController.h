...
@interface CurrImageryEditViewController : UIViewController<UIAlertViewDelegate,NSURLConnectionDelegate>{
    ...
    proAlertView* saveCurrImageryChangesAlert;
    ...
    IBOutlet UIView* hideColorsView;
